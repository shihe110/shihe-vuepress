...
- 新建springboot工程
  ...
  使用mysql，配置数据源-见【SpringBoot之整合mybatis.md]
...
public class GeneratorCodeConfig {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/sgd?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true");
...
# 方法二
logging.level.com.shihe.mapper=debug
```
